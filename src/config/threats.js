...
const THREATS_L1 = [
  ...
  //                                    === 6s RESPITE (resolve t=62 → next t=68) ===
  // === FINAL SURGE — dense pair salvos (4 threats, 68-75s) ===
  threat(22, 68, 'rocket', 'Ashkelon',        true,  5, 'full', 1.0, { origin: 'gaza' }),
  threat(23, 68, 'rocket', 'Netivot',         true,  5, 'full', 1.0, { origin: 'gaza' }),     // pair
  threat(25, 75, 'rocket', 'Sderot',          true,  5, 'full', 1.0, { origin: 'gaza' }),
  threat(26, 75, 'rocket', "Be'eri",          true,  5, 'full', 1.0, { origin: 'gaza' }),     // closing pair
  // === HOLD-FIRE — unguided Qassams landing in open ground ===
  threat(29, 29, 'rocket', 'Negev Desert',             false, 5, 'full', 1.0, { origin: 'gaza' }),   // between singles & pairs
  threat(31, 38, 'rocket', 'Sinai Border Region',      false, 5, 'full', 1.0, { origin: 'gaza' }),   // between pair waves
  threat(32, 51, 'rocket', 'Judean Hills',             false, 5, 'full', 1.0, { origin: 'gaza' }),   // after triple starts
  threat(39, 71, 'rocket', 'Negev Desert',             false, 5, 'full', 1.0, { origin: 'gaza' }),
  threat(40, 78, 'rocket', 'Dead Sea Region',          false, 5, 'full', 1.0, { origin: 'gaza' }),
];
...
const THREATS_L1_B = [
  ...
  //                                    === 6s RESPITE (resolve t=62 → next t=68) ===
  // === FINAL SURGE — dense pair salvos (4 threats, 68-75s) ===
  threat(22, 68, 'rocket', 'Sderot',          true,  5, 'full', 1.0, { origin: 'gaza' }),
  threat(23, 68, 'rocket', "Be'eri",          true,  5, 'full', 1.0, { origin: 'gaza' }),     // pair
  threat(25, 75, 'rocket', 'Kfar Aza',        true,  5, 'full', 1.0, { origin: 'gaza' }),
  threat(26, 75, 'rocket', 'Netivot',         true,  5, 'full', 1.0, { origin: 'gaza' }),     // closing pair
  // === HOLD-FIRE — unguided Qassams landing in open ground ===
  threat(29, 29, 'rocket', 'Negev Desert',             false, 5, 'full', 1.0, { origin: 'gaza' }),   // between singles & pairs
  threat(31, 38, 'rocket', 'Sinai Border Region',      false, 5, 'full', 1.0, { origin: 'gaza' }),   // between pair waves
  threat(32, 51, 'rocket', 'Judean Hills',             false, 5, 'full', 1.0, { origin: 'gaza' }),   // after triple starts
...
const THREATS_L2 = [
  ...
  threat(13, 33, 'rocket', 'Akko',             true,  7,  'full', 1.0, { origin: 'north' }),
  ...
  threat(15, 45, 'rocket', 'Haifa',            true,  7,  'full', 1.0, { origin: 'north' }),
  threat(16, 45, 'drone',  'Majdal Shams',     true,  9,  'full', 1.0, { origin: 'northeast' }),
  threat(17, 45, 'rocket', 'Tzfat',            true,  7,  'full', 1.0, { origin: 'north' }),        // triple!
  //                                    === 9s sub-wave gap ===
  threat(18, 54, 'drone',  'Teveriah',         true,  9,  'full', 1.0, { origin: 'northeast' }),
  threat(19, 54, 'rocket', 'Nahariya',         true,  7,  'full', 1.0, { origin: 'north' }),        // pair (reduced from triple)
  //                                    === 9s sub-wave gap ===
  threat(21, 63, 'rocket', 'Kiryat Shmona',    true,  7,  'full', 1.0, { origin: 'north' }),
  threat(22, 63, 'rocket', 'Katzrin',          true,  7,  'full', 1.0, { origin: 'northeast' }),
  ...
  threat(25, 72, 'rocket', 'Majdal Shams',     true,  7,  'full', 1.0, { origin: 'northeast' }),    // pair
  //                                    === CONTINUOUS into HEAVY ===
  // === HEAVY SALVOS — pairs and triples (7 threats, 81-103s) ===
  threat(27, 81, 'rocket', 'Haifa',            true,  6,  'full', 1.0, { origin: 'north' }),
  ...
  threat(31, 88, 'rocket', 'Teveriah',         true,  6,  'full', 1.0, { origin: 'northeast' }),
  threat(33, 88, 'drone',  'Upper Galilee',    false, 8,  'full', 1.0, { origin: 'north' }),        // triple (1 hold fire)
  //                                    === 8s sub-wave gap ===
  threat(34, 96, 'rocket', 'Haifa',            true,  6,  'full', 1.0, { origin: 'north' }),
  ...
  threat(38, 103,'rocket', 'Akko',             true,  6,  'full', 1.0, { origin: 'north' }),
  threat(39, 103,'rocket', 'Golan Heights',    false, 6,  'full', 1.0, { origin: 'northeast' }),    // pair (1 hold fire)
  //                                    === 4s BREATHING GAP (T38/39 end t=109 → CLOSING at t=103) ===
  // === CLOSING BARRAGE (6 threats, 103-114s) ===
  threat(40, 103,'rocket', 'Nahariya',         true,  6,  'full', 1.0, { origin: 'north' }),
  threat(41, 103,'drone',  'Haifa',            true,  8,  'full', 1.0, { origin: 'north' }),        // pair
  threat(43, 108,'drone',  'Kiryat Shmona',    true,  8,  'full', 1.0, { origin: 'north' }),
  threat(44, 108,'rocket', 'Tzfat',            true,  6,  'full', 1.0, { origin: 'north' }),        // pair!
  threat(48, 114,'drone',  'Teveriah',         true,  7,  'full', 1.0, { origin: 'northeast' }),
  threat(49, 114,'rocket', 'Nahariya',         true,  6,  'full', 1.0, { origin: 'north' }),        // closing pair!
  ...
  threat(60, 84, 'rocket', 'Upper Galilee',    false, 6,  'full', 1.0, { origin: 'north' }),
  threat(61, 92, 'rocket', 'Golan Heights',    false, 6,  'full', 1.0, { origin: 'northeast' }),
  threat(62, 100,'rocket', 'Western Galilee',  false, 6,  'full', 1.0, { origin: 'north' }),
  // T63 removed — was bridging into CLOSING respite
  threat(64, 122,'rocket', 'Golan Heights',    false, 6,  'full', 1.0, { origin: 'northeast' }),
];
...
const THREATS_L3 = [
  ...
  // === Phase 2: Introduce cruise missiles — solo tutorial at t=24 (6 threats, 24-33s) ===
  // T1-T3 clear by t=22. Window t=22-24 gives clean screen for first cruise tutorial.
  threat(4,  24, 'cruise', 'Tel Aviv',        true,  11, 'full', 1.0, { origin: 'east' }),         // ★ First cruise! SOLO for tutorial
  threat(5,  28, 'rocket', 'Judean Hills',    false, 7,  'full', 1.0, { origin: 'gaza' }),         // hold fire (after tutorial)
  threat(6,  30, 'cruise', 'Jerusalem',       true,  10, 'full', 1.0, { origin: 'east' }),         // Iran
  threat(7,  33, 'rocket', 'Holon',           true,  7,  'full', 1.0, { origin: 'gaza' }),         // Gaza
  ...
  threat(45, 42, 'rocket', 'Mediterranean (off-coast)', false, 7,  'full', 1.0, { origin: 'gaza' }),  // moved from t=16 to clear tutorial window
  threat(46, 36, 'rocket', 'Northern Negev',            false, 7,  'full', 1.0, { origin: 'gaza' }),  // moved from t=25 to clear tutorial window
...
const THREATS_L4 = [
  ...
  threat(4,  21, 'ballistic', 'Dimona Nuclear Reactor',   true,  12, 'full', 0.40, { origin: 'east', priority: true }),  // ★ First ballistic! SOLO for tutorial (T1 clears t=15, T2 clears t=19, T30 clears t=18)
  //                                    === 5s RESPITE (ballistic resolves t=33, next at t=38) ===
  ...
  threat(7,  44, 'drone',     'Rutenberg Power Station',  true,  11, 'full', 0.50, { origin: 'north' }),       // Hezbollah → energy (delayed reveal)
  ...
  //                                    === 4s RESPITE (last resolve ~t=65, next at t=69) ===
  // === Phase 3: Triples — real pressure (8 threats, 69-89s) ===
  threat(12, 69, 'ballistic', 'Dimona Nuclear Reactor',   true,  11, 'full', 0.35, { origin: 'east', priority: true }),  // Iran → nuclear
  threat(13, 72, 'cruise',    'BAZAN Oil Refinery',       true,  9,  'full', 1.0, { origin: 'east' }),         // Iran → energy
  threat(14, 72, 'drone',     'The Kirya (IDF HQ)',       true,  10, 'full', 1.0, { origin: 'north' }),        // Hezbollah → command (pair!)
  threat(15, 77, 'ballistic', 'Orot Rabin Power Station', true,  11, 'full', 0.40, { origin: 'east' }),        // Iran → energy
  threat(17, 81, 'drone',     'Sorek Desalination Plant', true,  10, 'full', 0.50, { origin: 'north' }),       // Hezbollah → water (delayed reveal)
  threat(18, 84, 'ballistic', 'Rutenberg Power Station',  true,  10, 'full', 0.40, { origin: 'east' }),        // Iran → energy
  threat(19, 87, 'cruise',    'Rutenberg Power Station',  true,  9,  'full', 1.0, { origin: 'east' }),         // Iran → energy
  threat(20, 89, 'drone',     'Ben Gurion Airport',       true,  10, 'full', 1.0, { origin: 'north' }),        // Hezbollah → transport
  //                                    === 3s RESPITE (last resolve ~t=99, next at t=98) ===
  // === Phase 4: Final surge — climax (9 threats, 98-112s) ===
  threat(21, 98, 'ballistic', 'Ben Gurion Airport',       true,  10, 'full', 0.35, { origin: 'east' }),        // Iran → transport
  threat(22, 98, 'cruise',    'Ashdod Port',              true,  9,  'full', 1.0, { origin: 'east' }),         // Iran → transport (pair!)
  threat(23, 101,'drone',     'The Kirya (IDF HQ)',       true,  10, 'full', 1.0, { origin: 'north' }),        // Hezbollah → command
  threat(24, 101,'ballistic', 'Sorek Desalination Plant', true,  10, 'full', 0.40, { origin: 'east' }),        // Iran → water (pair!)
  threat(25, 104,'cruise',    'Orot Rabin Power Station', true,  9,  'full', 1.0, { origin: 'east' }),         // Iran → energy
  threat(26, 104,'drone',     'BAZAN Oil Refinery',       true,  10, 'full', 1.0, { origin: 'north' }),        // Hezbollah → energy (pair!)
  threat(27, 108,'ballistic', 'The Kirya (IDF HQ)',       true,  11, 'full', 0.40, { origin: 'east' }),        // Iran → command
  threat(28, 108,'ballistic', 'Dimona Nuclear Reactor',   true,  10, 'full', 0.35, { origin: 'east', priority: true }),  // Iran → nuclear (pair!)
  threat(29, 112,'cruise',    'Ashdod Port',              true,  9,  'full', 1.0, { origin: 'east' }),         // Iran → transport
  // === HOLD-FIRE — duds/off-course during active phases (NOT in respite gaps) ===
  threat(30, 7,  'drone',     'Negev Desert',             false, 11, 'full', 1.0, { origin: 'east' }),  // moved from t=14 to clear ballistic tutorial window
  threat(31, 55, 'ballistic', 'Dead Sea Region',          false, 10, 'full', 0.45, { origin: 'east' }),
  threat(32, 77, 'cruise',    'Northern Negev',           false, 9,  'full', 1.0, { origin: 'east' }),
  threat(33, 102,'ballistic', 'Jordan Valley',            false, 10, 'full', 0.45, { origin: 'east' }),
];

// ============================================================
// THREATS_L5 array — Used by LEVEL 6 (Wave Assault)
// Duration: 160s | 51 threats (44 live, 7 hold-fire)
// Rocket hold-fire: ~40%. Drone: ~8%. Cruise: ~7%. Ballistic: ~13%. Hypersonic: 0%.
// Geography: Full country view. All 5 origins active (Yemen).
// All 5 threat types including hypersonic (added for L6 use).
// Wave assault from all fronts — intensified waves with preserved respites.
// Difficulty target: 8.0 (up from 7.0)
// ============================================================
const THREATS_L5 = [
  // === Phase 1: Full map introduction — showcase all 5 origins (6 threats, 4-22s) ===
  threat(1,  4,  'drone',     'Haifa',           true,  9,  'full', 1.0, { origin: 'north' }),       // Lebanon
  threat(2,  9,  'rocket',    'Sderot',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(3,  14, 'cruise',    'Tel Aviv',        true,  8,  'full', 1.0, { origin: 'east' }),        // Iran
  threat(4,  17, 'drone',     'Golan Heights',   false, 8,  'full', 1.0, { origin: 'northeast' }),   // hold fire, Syria
  threat(5,  20, 'ballistic', 'Nevatim AFB',     true,  10, 'full', 0.40, { origin: 'east' }),       // Iran
  threat(6,  22, 'drone',     'Eilat',           true,  8,  'full', 0.50, { origin: 'southeast' }),  // Yemen — first time! (delayed reveal)
  // === Phase 2: Pairs from multiple origins — intensified (12 threats, 28-52s) ===
  threat(7,  28, 'cruise',    'Jerusalem',       true,  7,  'full', 1.0, { origin: 'east' }),        // Iran (shortened from 8s)
  threat(8,  28, 'rocket',    'Ashkelon',        true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza (simultaneous pair!)
  threat(9,  33, 'ballistic', 'Tel Aviv',        true,  8,  'full', 0.40, { origin: 'east' }),       // Iran (shortened from 9s)
  threat(10, 33, 'drone',     'Beersheba',       true,  7,  'full', 1.0, { origin: 'southeast' }),   // Yemen (pair! shortened from 8s)
  threat(11, 37, 'cruise',    'Netanya',         true,  6,  'full', 1.0, { origin: 'east' }),        // Iran (shortened from 7s)
  threat(12, 40, 'rocket',    'Ashdod',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(48, 40, 'hypersonic', 'Dimona',          true,  6,  'full', 0.35, { origin: 'east', priority: true }),  // NEW: early hypersonic pressure
  threat(13, 44, 'ballistic', 'Haifa',           true,  7,  'full', 0.40, { origin: 'east' }),       // Iran (shortened from 8s)
  threat(14, 44, 'drone',     'Netanya',         true,  7,  'full', 0.50, { origin: 'north' }),      // Lebanon (pair!) (delayed reveal)
  threat(15, 48, 'cruise',    'Beersheba',       true,  6,  'full', 1.0, { origin: 'east' }),        // Iran (shortened from 7s)
  //                                    === 6s BREATHING GAP (T15 ends t=55 → P3 at t=63) ===
  // === Phase 3: Triples — multi-front pressure, intensified (12 threats, 63-89s) ===
  threat(17, 63, 'hypersonic', 'Dimona',          true,  6,  'full', 0.35, { origin: 'east', priority: true }),  // Iran → strategic (hypersonic)
  threat(18, 63, 'cruise',    'Haifa',           true,  6,  'full', 1.0, { origin: 'north' }),       // Lebanon (simultaneous! shortened from 7s)
  threat(19, 66, 'rocket',    'Sderot',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza (triple!)
  threat(20, 69, 'drone',     'Ashkelon',        true,  7,  'full', 1.0, { origin: 'north' }),       // Lebanon (shortened from 8s)
  threat(21, 72, 'ballistic', 'Ramat David AFB', true,  7,  'full', 0.40, { origin: 'east' }),       // Iran → base (shortened from 8s)
  threat(49, 72, 'rocket',    'Netivot',         true,  5,  'full', 1.0, { origin: 'gaza' }),        // NEW: simultaneous rocket
  threat(22, 75, 'cruise',    'Tel Aviv',        true,  6,  'full', 1.0, { origin: 'east' }),        // Iran (shortened from 7s)
  threat(23, 78, 'drone',     'Beersheba',       true,  7,  'full', 0.50, { origin: 'southeast' }),  // Yemen → population (delayed reveal)
  threat(24, 81, 'ballistic', 'Jerusalem',       true,  7,  'full', 0.40, { origin: 'east' }),       // Iran (shortened from 8s)
  threat(25, 84, 'cruise',    'Netanya',         true,  6,  'full', 1.0, { origin: 'east' }),        // Iran (shortened from 7s)
  threat(26, 87, 'rocket',    'Ashdod',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(50, 89, 'drone',     'Eilat',           true,  7,  'full', 1.0, { origin: 'southeast' }),   // NEW: Yemen trailing
  //                                    === 5s BREATHING GAP (T50 ends t=96 → P4 at t=101) ===
  // === Phase 4: Quads and sustained barrage — intensified (11 threats, 101-122s) ===
  threat(27, 101,'hypersonic', 'Palmachim AFB',   true,  5,  'full', 0.40, { origin: 'east' }),       // Iran → base (shortened from 6s)
  threat(28, 101,'cruise',    'Beersheba',       true,  6,  'full', 1.0, { origin: 'east' }),        // Iran (pair! shortened from 7s)
  threat(29, 104,'drone',     'Eilat',           true,  7,  'full', 1.0, { origin: 'southeast' }),   // Yemen (shortened from 8s)
  threat(30, 106,'rocket',    'Ashkelon',        true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(31, 109,'hypersonic', 'Tel Aviv',        true,  5,  'full', 0.35, { origin: 'east' }),       // Iran (shortened from 6s)
  threat(32, 109,'cruise',    'Jerusalem',       true,  6,  'full', 1.0, { origin: 'east' }),        // Iran (pair!)
  threat(51, 109,'rocket',    'Sderot',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // NEW: triple spawn!
  threat(33, 112,'drone',     'Haifa',           true,  7,  'full', 1.0, { origin: 'north' }),       // Lebanon (shortened from 8s)
  threat(34, 115,'rocket',    'Netivot',         true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(35, 119,'ballistic', 'Nevatim AFB',     true,  7,  'full', 0.40, { origin: 'east' }),       // Iran → base (shortened from 8s)
  threat(52, 122,'cruise',    'Haifa',           true,  6,  'full', 1.0, { origin: 'north' }),       // NEW: trailing pressure
  //                                    === 5s BREATHING GAP (T52 ends t=128 → P5 at t=134) ===
  // === Phase 5: Final salvo — all 5 threat types converge simultaneously ===
  // Buildup: t=134-137, then massive simultaneous burst at t=142-148
  threat(37, 134,'hypersonic', 'Dimona',          true,  5,  'full', 0.35, { origin: 'east', priority: true }),  // Iran → strategic
  threat(38, 137,'cruise',    'Tel Aviv',        true,  6,  'full', 1.0, { origin: 'east' }),        // Iran — building tension
  // === FINAL SALVO — multi-type simultaneous wave (t=142-148) ===
  threat(39, 142,'drone',     'Beersheba',       true,  7,  'full', 1.0, { origin: 'southeast', is_final_salvo: true }),   // Yemen
  threat(40, 142,'hypersonic', 'Haifa',           true,  5,  'full', 0.35, { origin: 'east', is_final_salvo: true }),       // Iran
  threat(55, 145,'ballistic', 'Nevatim AFB',     true,  7,  'full', 0.40, { origin: 'east', is_final_salvo: true }),       // Iran → base
  threat(41, 145,'rocket',    'Ashdod',          true,  5,  'full', 1.0, { origin: 'gaza', is_final_salvo: true }),        // Gaza
  threat(42, 145,'cruise',    'Netanya',         true,  6,  'full', 1.0, { origin: 'north', is_final_salvo: true }),       // Lebanon
  threat(56, 148,'rocket',    'Sderot',          true,  5,  'full', 1.0, { origin: 'gaza', is_final_salvo: true }),        // Gaza — trailing
  threat(57, 148,'drone',     'Eilat',           true,  7,  'full', 1.0, { origin: 'southeast', is_final_salvo: true }),   // Yemen — trailing
  // === HOLD-FIRE ROCKETS — unguided rockets missing populated areas (~40% miss rate) ===
  threat(43, 7,  'rocket', 'Northern Negev',            false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(44, 25, 'rocket', 'Mediterranean (off-coast)', false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(45, 36, 'rocket', 'Negev Desert',              false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(46, 75, 'rocket', 'Sinai Border Region',       false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(47, 105,'rocket', 'Northern Negev',            false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(53, 68, 'rocket', 'Western Negev',             false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(54, 125,'rocket', 'Sinai Border Region',       false, 5,  'full', 1.0, { origin: 'gaza' }),  // moved from t=140 to clear final salvo
];
...
const THREATS_L6 = [
  ...
  // WAVE 2: First hypersonic! (single, clear teaching moment — T3 cruise clears at t=22, T42 HF clears at t=22)
  threat(4,  24, 'hypersonic', 'Sdot Micha',        true,  10, 'full', 0.40, { origin: 'east' }),       // ★ First hypersonic! SOLO for tutorial
  threat(5,  34, 'ballistic',  'Negev Desert',      false, 11, 'full', 0.45, { origin: 'east' }),       // hold fire (moved from t=28 to not overlap tutorial)
...
const THREATS_L7 = [
  ...
  threat(1,  4,  'rocket',     'Sderot',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(2,  4,  'drone',      'Nahariya',        true,  9,  'full', 1.0, { origin: 'north' }),       // Lebanon
  threat(3,  6,  'cruise',     'Eilat',           true,  8,  'full', 1.0, { origin: 'southeast' }),   // Yemen
  threat(4,  8,  'ballistic',  'Negev Desert',    false, 9,  'full', 0.45, { origin: 'east' }),       // hold fire, Iran
  // === SALVO 2: 4 origins (5 threats, 16-20s) ===
  threat(5,  16, 'ballistic',  'Tel Aviv',        true,  9,  'full', 0.40, { origin: 'east' }),       // Iran
  threat(6,  16, 'rocket',     'Ashkelon',        true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(7,  18, 'drone',      'Katzrin',         true,  9,  'full', 1.0, { origin: 'northeast' }),   // Syria
  threat(8,  18, 'cruise',     'Beersheba',       true,  8,  'full', 0.50, { origin: 'southeast' }),  // Yemen (delayed reveal)
  threat(9,  20, 'drone',      'Arava Valley',    false, 9,  'full', 1.0, { origin: 'southeast' }),   // hold fire
  // === SALVO 3: All 5 origins! (5 threats, 30-34s) ===
  threat(10, 30, 'hypersonic', 'Jerusalem',       true,  7,  'full', 0.40, { origin: 'east' }),       // Iran
  threat(11, 30, 'rocket',     'Kfar Aza',        true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(12, 32, 'drone',      'Haifa',           true,  9,  'full', 1.0, { origin: 'north' }),       // Lebanon
  threat(13, 32, 'cruise',     'Arad',            true,  7,  'full', 0.50, { origin: 'southeast' }),  // Yemen (delayed reveal)
  threat(14, 34, 'ballistic',  'Golan Heights',   false, 8,  'full', 0.45, { origin: 'northeast' }), // hold fire, Syria
  // === SALVO 4: Quad — 4 origins (5 threats, 44-48s) ===
  threat(15, 44, 'hypersonic', 'Haifa',           true,  6,  'full', 0.35, { origin: 'east' }),       // Iran
  threat(16, 44, 'drone',      'Beersheba',       true,  9,  'full', 1.0, { origin: 'southeast' }),   // Yemen
  threat(17, 46, 'ballistic',  'Dimona',          true,  8,  'full', 0.35, { origin: 'east', priority: true }),  // Iran
  threat(18, 46, 'rocket',     'Sderot',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(19, 48, 'cruise',     'Central Negev',   false, 7,  'full', 1.0, { origin: 'east' }),        // hold fire
  // === SALVO 5: Triple front (4 threats, 56-60s) ===
  threat(20, 56, 'hypersonic', 'Tel Aviv',        true,  6,  'full', 0.35, { origin: 'east' }),       // Iran
  threat(21, 56, 'cruise',     'Netanya',         true,  7,  'full', 0.50, { origin: 'north' }),      // Lebanon (delayed reveal)
  threat(22, 58, 'rocket',     'Be\'eri',         true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(23, 60, 'ballistic',  'Nevatim AFB',     true,  8,  'full', 0.40, { origin: 'east' }),       // Iran → base
  // === SALVO 6: 4 origins again (5 threats, 68-72s) ===
  threat(24, 68, 'cruise',     'Jerusalem',       true,  7,  'full', 1.0, { origin: 'east' }),        // Iran
  threat(25, 68, 'drone',      'Majdal Shams',    true,  8,  'full', 1.0, { origin: 'northeast' }),   // Syria
  threat(26, 70, 'hypersonic', 'Netanya',         true,  6,  'full', 0.35, { origin: 'east' }),       // Iran
  threat(27, 70, 'rocket',     'Netivot',         true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(28, 72, 'drone',      'Judean Hills',    false, 9,  'full', 1.0, { origin: 'east' }),        // hold fire
  // === SALVO 7: All 5 origins — escalation (5 threats, 82-87s) ===
  threat(29, 82, 'ballistic',  'Ramat David AFB', true,  8,  'full', 0.40, { origin: 'east' }),       // Iran → base
  threat(30, 82, 'rocket',     'Ashdod',          true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  threat(31, 84, 'hypersonic', 'Beersheba',       true,  6,  'full', 0.35, { origin: 'east' }),       // Iran
  threat(32, 84, 'drone',      'Akko',            true,  8,  'full', 1.0, { origin: 'north' }),       // Lebanon
  threat(33, 87, 'cruise',     'Eilat',           true,  7,  'full', 1.0, { origin: 'southeast' }),   // Yemen
  // === SALVO 8: Pre-final push (4 threats, 97-102s) ===
  threat(34, 97, 'ballistic',  'Palmachim AFB',   true,  8,  'full', 0.40, { origin: 'east' }),       // Iran → base
  threat(35, 97, 'cruise',     'Holon',           true,  7,  'full', 1.0, { origin: 'east' }),        // Iran
  threat(36, 100,'hypersonic', 'Dimona',          true,  6,  'full', 0.35, { origin: 'east', priority: true }),  // Iran
  threat(37, 102,'rocket',     'Ashkelon',        true,  5,  'full', 1.0, { origin: 'gaza' }),        // Gaza
  // === FINAL SALVO — ALL 5 ORIGINS SIMULTANEOUSLY (7 threats, 125-130s) ===
  threat(38, 125,'hypersonic', 'Tel Aviv',        true,  6,  'full', 0.35, { origin: 'east', is_final_salvo: true }),       // Iran
  threat(39, 125,'rocket',     'Sderot',          true,  5,  'full', 1.0,  { origin: 'gaza', is_final_salvo: true }),       // Gaza
  threat(40, 126,'cruise',     'Haifa',           true,  7,  'full', 1.0,  { origin: 'north', is_final_salvo: true }),      // Lebanon
  threat(41, 126,'drone',      'Beersheba',       true,  9,  'full', 1.0,  { origin: 'southeast', is_final_salvo: true }), // Yemen
  threat(42, 128,'ballistic',  'Jerusalem',       true,  8,  'full', 0.35, { origin: 'east', is_final_salvo: true }),       // Iran
  threat(43, 128,'hypersonic', 'Dimona',          true,  6,  'full', 0.35, { origin: 'east', is_final_salvo: true, priority: true }),  // Iran
  threat(44, 130,'cruise',     'Northern Negev',  false, 7,  'full', 1.0,  { origin: 'northeast', is_final_salvo: true }), // hold fire, Syria
  // === EXTRA LIVE THREATS — intensifiers between salvos ===
  threat(45, 38, 'ballistic',  'Haifa',           true,  8,  'full', 0.40, { origin: 'east' }),       // Iran → population
  threat(46, 51, 'hypersonic', 'Palmachim AFB',   true,  6,  'full', 0.35, { origin: 'east' }),       // Iran → base
  threat(47, 51, 'cruise',     'Tel Aviv',        true,  7,  'full', 0.50, { origin: 'north' }),      // Lebanon → population (delayed reveal)
  threat(48, 78, 'rocket',     'Ashkelon',        true,  5,  'full', 1.0,  { origin: 'gaza' }),       // Gaza
  threat(49, 92, 'hypersonic', 'Netanya',         true,  6,  'full', 0.35, { origin: 'east' }),       // Iran → population
  threat(50, 105,'ballistic',  'Sdot Micha',      true,  8,  'full', 0.40, { origin: 'east' }),       // Iran → strategic base
  threat(51, 112,'cruise',     'Ashdod',          true,  7,  'full', 1.0,  { origin: 'east' }),       // Iran → population
  // === HOLD-FIRE ROCKETS — unguided rockets missing populated areas (~44% miss rate) ===
  threat(52, 10, 'rocket', 'Northern Negev',             false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(53, 23, 'rocket', 'Off-course (Jordan)',        false, 5,  'full', 1.0, { origin: 'east' }),
  threat(54, 36, 'rocket', 'Negev Desert',               false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(55, 52, 'rocket', 'Sinai Border Region',        false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(56, 64, 'rocket', 'Mediterranean (off-coast)',  false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(57, 80, 'rocket', 'Off-course (Red Sea)',       false, 5,  'full', 1.0, { origin: 'southeast' }),
  threat(58, 95, 'rocket', 'Central Negev',              false, 5,  'full', 1.0, { origin: 'gaza' }),
  threat(59, 115,'rocket', 'Off-course (Saudi Arabia)',  false, 5,  'full', 1.0, { origin: 'east' }),
];
...
export const LEVELS = [
  ...
  // Level 4: Strategic Threats — Ballistic Missiles + Arrow 2
  {
    id: 4,
    duration: 125,
    ammo: { iron_dome: 9, davids_sling: 10, arrow_2: 11 },
  ...
  // Final salvo at t=142-148: all 5 threat types simultaneously
  {
    id: 6,
    duration: 160,
    ammo: { iron_dome: 22, davids_sling: 12, arrow_2: 7, arrow_3: 6 },
    available_systems: ['iron_dome', 'davids_sling', 'arrow_2', 'arrow_3'],
    auto_end_delay: 6000,
    new_system: null,
    new_threat: null,
    final_salvo_warning_time: 130,
    final_salvo_start_time: 142,
    salvo_warnings: [{ time: 130, end_time: 142 }],
    threats: THREATS_L5,
  },
  // Level 7: Final Stand — multi-front simultaneous salvos, tight ammo
  {
    ...
    new_system: null,
    new_threat: null,
    final_salvo_warning_time: 105,
    final_salvo_start_time: 125,
    salvo_warnings: [{ time: 105, end_time: 125 }],
    threats: THREATS_L7,
  },
];
